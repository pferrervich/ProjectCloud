...
import com.pferrervich.core.DBObject;
import com.pferrervich.core.Restaurants;
import com.pferrervich.core.User;
    ...
    public static void main(String... args) {
        ...
        get("/restaurants", (request, response) -> {
            ...
            if (shouldReturnHtml(request)) {
                ...
                model.put("posts", lRest);
                model.put("title", "Restaurants");
                model.put("subtitle", "Llista dels millors restaurants de Mallorca");
                ...
                return mapper.writeValueAsString(lRest);
            }
        });
